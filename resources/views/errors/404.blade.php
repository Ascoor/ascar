...
<head>
  <meta charset="UTF-8">
  <title>Triangles Animation</title>
...
<div class="logo">
		...
		<img src="/img/Coat.png" class="rounded mx-auto d-block" style="align-items:center;">
	</div>
	<div class="title-block">
		<h1 class="title" style="font-size: 60"> هناك خطأ</h1>
		<a class="btn btn-primary btn-lg" type=" button"
		style="font-size:42px;color:#24cae4;text-align:center;
	" href="{{route('places')}}">اضغط هنا للرجوع</a>
</div>
</center>
</div>
</body>
