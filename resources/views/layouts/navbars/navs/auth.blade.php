...
<nav class="navbar navbar-light" style="background-color: #b9def8;">
    ...
    <a style="font-size: 49px; color:rgba(37, 44, 0, 0.927)" class="navbar-brand" href="{{ route('places.index') }}">
        محافظة الدقهلية
    </a>
    <img src="/img/coat.png" width="100" height="100" alt="">
    </span>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav mr-auto">
            <li class="nav-item active">
                <a class="nav-link" href="{{ route('places.index') }}">الصفحة الرئيسية <span
